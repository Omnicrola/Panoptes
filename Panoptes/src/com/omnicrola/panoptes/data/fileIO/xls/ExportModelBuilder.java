...
public class ExportModelBuilder {
	...
	public ExportModelBuilder(DataController controller) {
		this.controller = controller;
	}

	public List<ExportDataRow> buildDataRows(TimeblockSet timeblocks) {
		List<IReadTimeblock> blockSet = timeblocks.getBlockSet();
		HashMap<String, WorkStatement> projectNameMap = buildWorkstatementHashMap(this.controller.getWorkStatements());
	...
	public HashMap<String, InvoiceRow> buildInvoiceRows(XSSFWorkbook workbook, List<ExportDataRow> exportList) {
	...
	private HashMap<String, WorkStatement> buildWorkstatementHashMap(List<WorkStatement> workStatements) {
	...
	private ExportDataRow createNewRow(HashMap<String, ExportDataRow> rowMap, IReadTimeblock timeBlock,
