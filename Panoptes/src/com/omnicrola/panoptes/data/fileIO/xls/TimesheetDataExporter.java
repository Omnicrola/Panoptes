...
public class TimesheetDataExporter {
    ...
    private void writeTimesheetRow(XSSFRow sheetRow, ExportDataRow dataRow) {
        ...
        setCellValue(sheetRow, 6, dataRow.getDay(0), true);
        setCellValue(sheetRow, 7, dataRow.getDay(1), true);
        setCellValue(sheetRow, 8, dataRow.getDay(2), true);
        setCellValue(sheetRow, 9, dataRow.getDay(3), true);
        setCellValue(sheetRow, 10, dataRow.getDay(4), true);
        setCellValue(sheetRow, 11, dataRow.getDay(5), true);
        setCellValue(sheetRow, 12, dataRow.getDay(6), true);
