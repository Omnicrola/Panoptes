...
public class DialogFactoryToolbox {
	...
	public static JTextField makeField(int width) {
		return makeField(width, "");
	}

	public static JTextField makeField(int width, String content) {
	...
	public static JLabel makeLabel(String string, Font font) {
